...
public class LedTasks {
    ...
    public final TimedTask ranging;
    ...
    public LedTasks(Intake intake, Robot robot) {
        ...
        ranging = new TimedTask("ranging", ledTasksGroup);
...
//        ejecting.addStep(() -> rgbIndicator.setPosition(rgbIndicatorColor.Off.color));
        ...
        ranging.autoStart = false;
        ranging.addStep(() -> rgbIndicator.setPosition(rgbIndicatorColor.Orange.color));
        ranging.addDelay(40);
        ranging.addStep(() -> rgbIndicator.setPosition(rgbIndicatorColor.Off.color));
